export const plants = [
  ...
  {
    id: "2",
    species: "STILL LOCAL DATA",
    commonName: "STILL LOCAL DATA",
    waterNeeds: "monthly",
    sunlightRequirements: "full sun",
    size: "medium",
    ...
    description:
      "STILL LOCAL DATA is well-known for its succulent leaves with healing properties. It requires infrequent watering and thrives in bright indirect light. A versatile plant that adds a touch of green and serves practical purposes.",
    petFriendly: false,
